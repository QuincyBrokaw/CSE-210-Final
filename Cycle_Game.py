...
class ControlActorsAction(Action):
    ...
    def execute(self, cast, script):
        ...
        if (self._keyboard_service.is_key_down('k') or 
           self._keyboard_service.is_key_down('i') or
           self._keyboard_service.is_key_down('l') or 
           self._keyboard_service.is_key_down('j')):
            cycle = cast.get_first_actor("cycles2")
            cycle.turn_head(self._direction)
        elif (self._keyboard_service.is_key_down('a') or
            self._keyboard_service.is_key_down('d') or
            self._keyboard_service.is_key_down('w') or             
            self._keyboard_service.is_key_down('s')):  
...
def main():
    ...
    cast.add_actor("cycles", Cycle(30, 45))
    cast.add_actor("scores", Score())
    #cast.add_actor("scores2", Score2())
    cast.add_actor("cycles2", Cycle(80, 80))
    ...
    script.add_action("input2", ControlActorsAction(keyboard_service))
